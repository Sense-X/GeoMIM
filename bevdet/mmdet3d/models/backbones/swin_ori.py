    ...
    def __init__(self,
        ...
        for i in range(depth):
            ...
            block = SwinBlock(
                ...
                act_cfg=act_cfg,
                norm_cfg=norm_cfg,
                with_cp=with_cp if isinstance(with_cp, bool) else i < with_cp,
                init_cfg=None,
            )
...
class SwinTransformerOri(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        super(SwinTransformerOri, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformerOri, self).train(mode)
        # self._freeze_stages()
    ...
    def init_weights(self):
        ...
        if self.init_cfg is None:
            ...
            if self.pretrain_style == 'official' or self.convert_weights:
